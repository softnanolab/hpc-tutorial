...
- **See section #1a below** or find the input file here [oxDNA minimisation input file](/oxDNA-simuations/oxdna.min.in)

- **See section #1b below** or find the input file here [oxDNA simulation input file](/oxDNA-simuations/oxdna.sim.in)
...
- **See: section #2 below** or find the input file here [PBS input file](/oxDNA-simuations/pbs_input_file)
...
- You can find a description of all input file parameters
    ...
    - and here: [documentation from src](/oxDNA-simuations/input_options.md) - a much more in-depth source of information, copied from the oxDNA source code and put here for accessibility
...
## 2. [PBS input file](/oxDNA-simuations/pbs_input_file) example for an oxDNA simulation at different temperatures
